...
def take_snapshot
  ...
  # Remove today's snapshot if it already exists, then add new one
...
# Schedule daily snapshot at 5:00 PM CST
# Note: Rufus scheduler uses system time, adjust for your server's timezone
...
<head>
  ...
  <style>
    * {
    ...
    .view-selector a, .view-selector button {
      padding: 8px 16px;
      background: white;
      color: #667eea;
      text-decoration: none;
    ...
    .view-selector a:hover, .view-selector button:hover {
      background: #667eea;
      color: white;
    }
